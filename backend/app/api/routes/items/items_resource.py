...
from app.services.items import check_item_exists, get_slug_for_item, get_item_image_if_not_exists
...
async def create_new_item(
    ...
    image = get_item_image_if_not_exists(item_create.title, item_create.image)
